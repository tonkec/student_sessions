  ...
  render() {
    ...
    return(
      <div>
        ...
        <p> Total time spent on sessions: <span> {duration._data.hours}h: {duration._data.minutes}m: {duration._data.seconds}s</span> </p>
      </div>
    )
  }
}
...
const mapStateToProps = (state,props) => {
  let studentSessions = state.sessions.filter((s) => s.studentEmail === props.match.params.email)
  return {
